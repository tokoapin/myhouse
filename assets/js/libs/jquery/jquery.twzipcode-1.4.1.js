    ...
    var methods = {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $('<input/>').attr({'type': 'text', 'name': opts.addressName}).appendTo(this);
                ...
                wrap.selector = {
                    ...
                    address: 'input[type=text][name="' + opts.addressName + '"]'
                };
                ...
                wrap.address = self.children(wrap.selector.address);
                ...
                try {
                    ...
                    wrap.address.addClass(opts.css[3]);
                } catch (e) {
                }

                // append address
                if (opts.addressSel) {
                    wrap.address.val(opts.addressSel);
                }
                /*
